...
router.post("/order", (0, validate_1.validate)(payment_validation_1.createOrderSchema), paymentController.createOrder);
router.post("/verify", (0, validate_1.validate)(payment_validation_1.verifyPaymentSchema), paymentController.verifyPayment);
