...
export default function LoginPage() {
  return (
    <div className="max-w-7xl mx-auto min-h-[calc(100vh-200px)] flex rounded-2xl overflow-hidden border border-border">
      {/* Left Side - Form */}
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <Link href="/" className="flex items-center gap-2.5 mb-8 group">
            ...
            <span className="text-xl font-bold text-text">EduPortal</span>
          </Link>
          ...
          <div className="mt-6 p-4 bg-primary-50/50 rounded-xl border border-primary-100">
            ...
            <p className="text-xs text-primary-500 mt-1.5">Password: Admin@123 / Student@123 / Teacher@123</p>
          </div>
        </div>
      </div>
