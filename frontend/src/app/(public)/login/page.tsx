    ...
    <div className="min-h-[calc(100vh-200px)] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <Link href="/" className="flex items-center gap-2.5 mb-8 group">
            ...
            <span className="text-xl font-bold text-neutral-900">EduPortal</span>
          </Link>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="flex items-center justify-center gap-2 h-11 px-4 rounded-xl border border-neutral-200 bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300 transition-all">
          ...
          <div className="mt-6 p-4 bg-primary-50/50 rounded-xl border border-primary-100">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-primary-600">
              <p><span className="font-medium">Admin:</span> admin@education.com</p>
              <p><span className="font-medium">Student:</span> student@education.com</p>
              <p><span className="font-medium">College:</span> college@education.com</p>
              <p><span className="font-medium">Teacher:</span> teacher@education.com</p>
            </div>
            <p className="text-xs text-primary-500 mt-1.5">Password: Admin@123 / Student@123 / College@123 / Teacher@123</p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 relative overflow-hidden">
        ...
        <div className="relative max-w-md text-center text-white p-8">
          ...
          <p className="text-primary-200/80 leading-relaxed mb-8">
            Join 50,000+ students who trust EduPortal for their education decisions. Access personalized recommendations, expert guidance, and comprehensive college data.
          </p>
