...
import { FiFileText, FiHome, FiArrowRight, FiEye } from "react-icons/fi";
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Track all your college applications</p>
          </div>
          <Link href="/colleges">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {statusCounts.map((item) => (
            <div 
              key={item.status}
              className={`cursor-pointer ${statusFilter === item.status ? 'ring-2 ring-indigo-500' : ''}`}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-gray-900">{(app as any).college?.name}</p>
