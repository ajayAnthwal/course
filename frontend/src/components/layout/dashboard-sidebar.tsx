...
const navItems: Record<UserRole, NavItem[]> = {
  admin: [
    ...
    { label: "Exams", href: "/dashboard/admin/exams", icon: "📝" },
    ...
    { label: "Follow-ups", href: "/dashboard/admin/followups", icon: "📞" },
    { label: "Documents", href: "/dashboard/admin/documents", icon: "📄" },
    { label: "Activity Logs", href: "/dashboard/admin/activity-logs", icon: "📜" },
  ...
  student: [
    ...
    { label: "Discover Colleges", href: "/dashboard/student/colleges", icon: "🔍" },
    ...
    { label: "Reviews & Q&A", href: "/dashboard/student/reviews", icon: "⭐" },
